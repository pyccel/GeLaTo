...
_linear_form_header_1d_scalar = '#$ header procedure {__KERNEL_NAME__}(int, int, int, double [:,:,:], double [:,:,:], double [:], double [:], double [:,:]{__TYPES__}{__FIELD_TYPES__})'
# .............................................
...
_linear_form_header_2d_scalar = '#$ header procedure {__KERNEL_NAME__}(int, int, int, int, int, int, double [:,:,:], double [:,:,:], double [:,:,:], double [:,:,:], double [:], double [:], double [:], double [:], double [:,:,:,:]{__TYPES__}{__FIELD_TYPES__})'
# .............................................
...
_linear_form_header_3d_scalar = '#$ header procedure {__KERNEL_NAME__}(int, int, int, int, int, int, int, int, int, double [:,:,:], double [:,:,:], double [:,:,:], double [:,:,:], double [:,:,:], double [:,:,:], double [:], double [:], double [:], double [:], double [:], double [:], double [:,:,:,:,:,:]{__TYPES__}{__FIELD_TYPES__})'
# .............................................
...
_linear_form_header_2d_block = '#$ header procedure {__KERNEL_NAME__}(int, int, int, int, int, int, double [:,:,:], double [:,:,:], double [:,:,:], double [:,:,:], double [:], double [:], double [:], double [:], {__MAT_TYPES__}{__TYPES__}{__FIELD_TYPES__})'
# .............................................
...
_linear_form_header_3d_block = '#$ header procedure {__KERNEL_NAME__}(int, int, int, int, int, int, int, int, int, double [:,:,:], double [:,:,:], double [:,:,:], double [:,:,:], double [:,:,:], double [:,:,:], double [:], double [:], double [:], double [:], double [:], double [:], {__MAT_TYPES__}{__TYPES__}{__FIELD_TYPES__})'
# .............................................
