...
def test_kernel_bilinear_3d_scalar_2():
    ...
    # ...
    kernel_py  = compile_kernel('kernel_bilinear_3d_scalar_2', a,
                                backend='python', verbose=True)
    # ...
# ...
...
def test_kernel_bilinear_3d_scalar_3():
    ...
    # ...
    kernel_py  = compile_kernel('kernel_bilinear_3d_scalar_3', a,
                                backend='python', verbose=True)
    # ...
# ...
...
def test_kernel_bilinear_3d_scalar_4():
    ...
    # ...
    kernel_py  = compile_kernel('kernel_bilinear_3d_scalar_4', a,
                                backend='python', verbose=True)
    # ...
# ...
