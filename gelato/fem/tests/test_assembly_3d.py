...
# ...
def test_assembly_function_3d_scalar_1():
    ...
    expr = F-x*(1. - x)*y*(1. - y)*(1. - z)

    a = FunctionForm(expr)
    print('> input      >>> {0}'.format(a))

    # ...
    assembly_py  = compile_assembly('assembly_function_3d_scalar_1', a,
                                    backend='python', verbose=True)
    # ...
# ...
...
if __name__ == '__main__':
    ...
    test_assembly_function_3d_scalar_1()
    # ...
