...
def test_kernel_linear_2d_scalar_2():
    ...
    # ...
    kernel_py  = compile_kernel('kernel_linear_2d_scalar_2', a,
                                backend='python', verbose=True)
    # ...
# ...

# ...
def test_kernel_linear_2d_scalar_3():
    ...
    # ...
    kernel_py  = compile_kernel('kernel_linear_2d_scalar_3', a,
                                backend='python', verbose=True)
    # ...
# ...

# ...
def test_kernel_linear_2d_scalar_4():
    ...
    # ...
    kernel_py  = compile_kernel('kernel_linear_2d_scalar_4', a,
                                backend='python', verbose=True)
    # ...
# ...
...
def test_kernel_function_2d_scalar_1():
    ...
    # ...
    kernel_py  = compile_kernel('kernel_function_2d_scalar_1', a,
                                backend='python', verbose=True)
    # ...
# ...

# ...
def test_kernel_function_2d_scalar_2():
    ...
    # ...
    kernel_py  = compile_kernel('kernel_function_2d_scalar_2', a,
                                backend='python', verbose=True)
    # ...
# ...
...
if __name__ == '__main__':
    ...
    test_kernel_linear_2d_scalar_3()
    test_kernel_linear_2d_scalar_4()

    test_kernel_function_2d_scalar_1()
    test_kernel_function_2d_scalar_2()
    # ...
